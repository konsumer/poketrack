...
typedef enum { SFZ_LOOP_NONE = 0, SFZ_LOOP_CONTINUOUS, SFZ_LOOP_ONE_SHOT } SfzLoopMode;
...
typedef enum { SFZ_ENV_ATTACK, SFZ_ENV_HOLD, SFZ_ENV_DECAY, SFZ_ENV_SUSTAIN, SFZ_ENV_RELEASE } SfzEnvState;
...
typedef enum { SFZ_MODE_NONE, SFZ_MODE_GLOBAL, SFZ_MODE_GROUP, SFZ_MODE_CONTROL, SFZ_MODE_REGION } SfzMode;
