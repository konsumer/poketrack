...
lines.push('//')
lines.push('// Patch data decoded from one or more Roland Juno-1/Juno-2/MKS-50')
lines.push('// (Alpha Juno) bulk-dump SysEx banks — see plugins/juno1/README.md for')
lines.push('// exactly which banks and their provenance/licensing (this can combine')
lines.push('// banks with different licenses/provenance in one run). Treat this')
lines.push('// file — and any compiled plugin binary that embeds it — as')
lines.push('// GPL-3.0-or-later, NOT the zlib license that covers the rest of')
lines.push('// poketrack, unless the README says every bank that went into it is')
lines.push('// unambiguously more permissive than that.')
lines.push('')
